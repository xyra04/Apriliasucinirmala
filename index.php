        ...
        <div class="row text-center">
          ...
          <div class="col-12 col-lg-4 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Bakso Gepeng</h5>
          ...
          <div class="col-12 col-lg-4 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Tahu Mercon</h5>
          ...
          <div class="col-12 col-lg-4 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Kopi Cucu</h5>
          ...
          <div class="col-12 col-lg-4 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Jeruk Asem</h5>
      ...
      <section id="contact">
        ...
        <div class="col-10 col-md-6">
          ...
          <div class="col-10 col-md-4">
            ...
            <p><i class="fas fa-map-pin"></i> Gg Al awab Cimone Karawaci Kota Tangerang</p>
            <h2 class="my-3">Contact</h2>
            <p><i class="fas fa-user"></i> Aprilia Suci Nirmala</p>
            <p><i class="fas fa-brands fa-whatsapp"></i> 089514826752</p>
            <p><i class="fas fa-envelope"></i> apriliasucinirmala@mail.com</p>
          </div>
      </div>   
    </section>
